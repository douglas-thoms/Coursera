...
The median for the NA subsituted dataset is `r as.character(median(stepsPerDayNAremoved$steps.per.day, na.rm = TRUE))`.

The mean for the NA subsituted dataset is `r as.character(round(mean(stepsPerDayNAremoved$steps.per.day, na.rm = TRUE),1))`.  
